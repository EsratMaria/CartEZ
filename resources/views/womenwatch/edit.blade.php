    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Women's Watch Insert
                ...
                {!!Form::model($item, ['method'=>'PATCH','action'=>['WomenwatchController@update',$item->item_id],'files'=>true]) !!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="band_length" class="col-2 col-form-label">Band Length :</label>
                    <input class="form-control" name ="band_length" type="text" placeholder="Band Length" value="{{$item->band_length}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="display_type" class="col-2 col-form-label">Display Type :</label>
                    <input class="form-control" name ="display_type" type="text" placeholder="Display Type" value="{{$item->display_type}}" required>
                </div>

                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="case_material" class="col-2 col-form-label">Case Material :</label>
                    <input class="form-control" name ="case_material" type="text" placeholder="Case Material" value="{{$item->case_material}}" required>
                </div>

                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="band_material" class="col-2 col-form-label">Band Material :</label>
                    <input class="form-control" name ="band_material" type="text" placeholder="Band Material" value="{{$item->band_material}}" required>
                </div>
