    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                {!!Form::open(['method'=>'POST', 'action'=>'WomenwatchController@store','files'=>true ])!!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="band_length" type="text" placeholder="Band Length" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="display_type" class="col-2 col-form-label">Display Type :</label>
                    <input class="form-control" name ="display_type" type="text" placeholder="Display Type" required>
                </div>

                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="case_material" class="col-2 col-form-label">Case Material :</label>
                    <input class="form-control" name ="case_material" type="text" placeholder="Case Material" required>
                </div>

                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="band_material" class="col-2 col-form-label">Band Material :</label>
                    <input class="form-control" name ="band_material" type="text" placeholder="Band Material" required>
                </div>
