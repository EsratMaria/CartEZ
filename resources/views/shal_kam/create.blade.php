    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                {!!Form::open(['method'=>'POST', 'action'=>'Shal_kamController@store','files'=>true ])!!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="fabric" type="text" placeholder="Enter Fabric" required>
                </div>

                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="dupatta_fabric" class="col-2 col-form-label">Dupatta Fabric :</label>
                    <input class="form-control" name ="dupatta_fabric" type="text" placeholder="Enter Dupatta Fabric" required>
                </div>

                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="bottom_fabric" class="col-2 col-form-label">Bottom Fabric :</label>
                    <input class="form-control" name ="bottom_fabric" type="text" placeholder="Enter Bottom Fabric" required>
                </div>
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="dupatta_color" type="text" placeholder="Enter Dupatta Color" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="bottom_color" class="col-2 col-form-label">Bottom Color :</label>
                    <input class="form-control" name ="bottom_color" type="text" placeholder="Enter Bottom Color" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="dupatta_value_addition" type="text" placeholder="Enter Dupatta Value Addition" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="bottom_value_addition" class="col-2 col-form-label">Bottom Value Addition :</label>
                    <input class="form-control" name ="bottom_value_addition" type="text" placeholder="Enter Bottom Value Addition" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="sleeve" class="col-2 col-form-label">Sleeve :</label>
                    <input class="form-control" name ="sleeve" type="text" placeholder="Enter Sleeve" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="waist" type="text" placeholder="Enter Waist" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="lining" class="col-2 col-form-label">Lining :</label>
                    <input class="form-control" name ="lining" type="text" placeholder="Enter Lining" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
