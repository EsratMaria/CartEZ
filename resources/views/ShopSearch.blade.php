                            ...
                            <div class="grid1_of_4">
                                ...
                                @foreach($products as $p)
                                    ...
                                    <div class="content_box" ><a href="#">
                                            ...
                                            @endif
                                                @php
                                                    $name=DB::table('products')->where('prod_id',$product->item_id)->value('table_name');
                                                @endphp
                                            <h4><a href="{{ route('product-show',[$name ,$product->item_id])}}">{{ $product->title }}</a></h4>
                                            ...
                                            <div class="grid_1 simpleCart_shelfItem">
                                                ...
                                                <div class="item_add"><span class="item_price"><a href="{{ route('product-show',[$name, $product->item_id])}}">View Details</a></span></div>
                                            </div>
