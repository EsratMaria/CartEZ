    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;">Edit Women's Shoe Items
                ...
                {!!Form::model($item, ['method'=>'PATCH','action'=>['WomenshoeController@update',$item->item_id],'files'=>true]) !!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="upper_value_addition" type="text" placeholder="Upper Value Addition" value="{{$item->upper_value_addition}}" required>
                </div>
