                        ...
                        <!-- PAGE CONTENT BEGINS -->
                            ...
                            <div class="row">
                                <div class="col-lg-20">
                                    ...
                                    <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Camera product Insert
                                    </h2>
                                    {!!Form::open(['method'=>'POST', 'action'=>'CamerasController@store','files'=>true ])!!}
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                        ...
                                        <input class="form-control" name ="type" type="text" placeholder="Enter Connectivity Type" required>
                                    </div>
                                    <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
