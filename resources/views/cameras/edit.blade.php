                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-lg-20">
                                ...
                                <h2 class="row" style="padding-left: 60px;color: lightslategrey;">Edit Camera Items
                               </h2>
                                {!!Form::model($item, ['method'=>'PATCH','action'=>['CamerasController@update',$item->item_id],'files'=>true]) !!}
                                {{ csrf_field() }}
                                ...
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    ...
                                    <input class="form-control" name ="type" type="text" placeholder="Enter Connectivity Type" value="{{$item->type}}" required>
                                </div>
