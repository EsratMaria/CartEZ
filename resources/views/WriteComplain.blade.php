            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title"style="color: red"><b>Write Your Complain Here</b></h4>
                            </div>

                            <div class="content">
                                <form id="form" action="{{route('alert',['id1'=> $id])}}" method="post">
                                    {{Form::open()}}
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 500px;">
                                    ...
                                    <textarea class="form-control" name ="msg" rows= "5" type="text" placeholder="Enter complain here.." required></textarea>
                                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title"style="color: #953b39"><b>Your Previous Complaints and Replies</b></h4>
                            </div>
                            ...
                            <div class="content">
                                ...
                                @foreach($complain as $com)
                                       ...
                                       You complained about  {{$com->prod_id}} {{'  '}} <a href ="{{route('mailbox',['id'=> $com->id])}}" style="color: #ef7c61">View Replies</a>
                                        <br>
