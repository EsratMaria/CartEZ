                        ...
                        <!-- PAGE CONTENT BEGINS -->
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h1 class="title" style="color: lightslategrey;">Category/Subcategory View</h1>
                                    <hr />
                                </div>
                            </div>
                                {!!Form::open(['method'=>'GET','url'=>'/get'])!!}
                                {{ csrf_field() }}

                                <div class="form-group" style="width: 1000px; padding-left: 400px">
                                ...
                                <div class="form-group" style="padding-left: 350px">
                                    <div class="col-lg-5 col-lg-offset-3">
                                        {!! Form::submit('Show Product list',['class'=>'btn btn-success']) !!}
                                    </div>
                                </div>
                        ...
                        <script>
                            $('#category').on('change',function(e){
                                ...
                                $.get('ajax-subcat?cat_id=' + cat_id, function(data){
                                    ...
                                    //success data
                                    $('#subcategory').empty();
                                    $.each(data,function(addproduct,subcatObj){
