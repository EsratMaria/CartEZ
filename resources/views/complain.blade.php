...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="container" style="background: cornsilk"><br>
        <h1 style="font-size: large; color: #001a35; font-weight: bold; margin: 5px;">Not Satisfied With a Product? You Can Complain Here..</h1>
        <br>
            @foreach($transaction as $trans)
                @foreach($trans->cart->items as $item)
                    <ul>
                        <li>
                            <span class="badge"><a href="{{route('product.complain', ['id'=> $item['item']['item_id']])}}">Complain</a></span>
                            {{$item['item']['title']}}
                        </li>
                    </ul>
                @endforeach
