                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row" style="padding-left: 70px;padding-right: 70px;">
                            <h2 style="font-size: 28px;color: lightslategrey;">Kitchen Appliances collection
                                <a href="kitchens/create"><span class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-original-title="Add more Products"></span></a>
                            </h2>
                            <hr>
                            @if(count($items)!=0)
