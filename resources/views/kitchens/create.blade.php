                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-lg-20">
                                ...
                                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Kitchen Appliances product Insert
                                </h2>
                                {!!Form::open(['method'=>'POST', 'action'=>'KitchensController@store','files'=>true ])!!}
                                {{ csrf_field() }}
