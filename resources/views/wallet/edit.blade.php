    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Men's Wallet Insert
                ...
                {!!Form::model($item, ['method'=>'PATCH','action'=>['WalletController@update',$item->item_id],'files'=>true]) !!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="size" type="text" placeholder="Enter Size" value="{{$item->size}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="type" class="col-2 col-form-label">Type :</label>
                    <input class="form-control" name ="type" type="text" placeholder="Type" value="{{$item->type}}" required>
                </div>
