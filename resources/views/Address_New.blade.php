    ...
    <div class="main-panel">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="content">
                    <form id="form" action="{{ route('address') }}" method="post">
                        {{Form::open()}}
                        {{Form::textarea('newadd', null, array('rows'=>'4','id'=>'new-review','class'=>'form-control animated','placeholder'=>'Enter your address here...'))}}
                        <br>
