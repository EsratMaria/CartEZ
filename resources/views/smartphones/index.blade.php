...
@section('content')
    ...
    <div class="row" style="padding-left: 70px;padding-right: 70px;">
        <h2 style="font-size: 28px;color: lightslategrey;">Smartphones collection
            <a href="smartphones/create"><span class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-original-title="Add more Products"></span></a>
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="text-center" style="margin-bottom: 50px;">
                            ...
                            <div style="padding-left: 110px; ">
                                {!!Form::model($item,['method'=>'GET','action'=>['SmartphonesController@edit',$item->item_id]]) !!}
                                {{ csrf_field() }}
                            ...
                            <div>
                                {!!Form::model($item,['method'=>'DELETE','action'=>['SmartphonesController@destroy',$item->item_id]]) !!}
                                {{ csrf_field() }}
