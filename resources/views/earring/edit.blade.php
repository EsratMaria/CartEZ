    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Edit Women's Earring
                ...
                {!!Form::model($item, ['method'=>'PATCH','action'=>['EarringController@update',$item->item_id],'files'=>true]) !!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="stone_beads" type="text" placeholder="Enter Stone Beads" value="{{$item->stone_beads}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="stone_cut" class="col-2 col-form-label">Stone Cut :</label>
                    <input class="form-control" name ="stone_cut" type="text" placeholder="Enter Stone Cut" value="{{$item->stone_cut}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="back_type" class="col-2 col-form-label">Back Type:</label>
                    <input class="form-control" name ="back_type" type="text" placeholder="Enter Back Type" value="{{$item->back_type}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="diameter" type="text" placeholder="Enter Diameter" value="{{$item->diameter}}" required>
                </div>
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="care" type="text" placeholder="Care" value="{{$item->care}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
