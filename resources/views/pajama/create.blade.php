    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Men's Pajama Insert
                ...
                {!!Form::open(['method'=>'POST', 'action'=>'PajamaController@store','files'=>true ])!!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="waist" type="text" placeholder="Waist" required>
                </div>
