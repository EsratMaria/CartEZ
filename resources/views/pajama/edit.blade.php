...
@section('content')
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;">Edit Men's Pajama Items
                ...
                {!!Form::model($item, ['method'=>'PATCH','action'=>['PajamaController@update',$item->item_id],'files'=>true]) !!}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="waist" type="text" placeholder="Waist"  value="{{$item->waist}}" required>
                </div>
