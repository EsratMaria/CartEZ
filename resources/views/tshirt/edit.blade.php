...
@section('content')
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;">Edit Men's T-Shirt Items
                ...
                {!!Form::model($item, ['method'=>'PATCH','action'=>['TshirtController@update',$item->item_id],'files'=>true]) !!}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <textarea class="form-control" name ="value_addition" rows= "3" type="text" placeholder="Enter Value Addition"  value="{{$item->value_addition}}" required></textarea>
                </div>
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <select name="shirt_type" class="form-control" placeholder="Choose Shirt Type:" value="{{$item->shirt_type}}" required>
