    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Men's T-Shirt Insert
                ...
                {!!Form::open(['method'=>'POST', 'action'=>'TshirtController@store','files'=>true ])!!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="shirt_type" class="col-2 col-form-label">Shirt Type :</label>
                    <select name="shirt_type" class="form-control" placeholder="Choose Shirt type:" required>
