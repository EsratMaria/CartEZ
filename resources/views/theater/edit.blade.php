    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;">Edit Home Theater Items
                ...
                {!!Form::model($item, ['method'=>'PATCH','action'=>['TheaterController@update',$item->item_id],'files'=>true]) !!}
                {{ csrf_field() }}
