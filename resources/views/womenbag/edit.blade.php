    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Edit Women's Bag
                ...
                {!!Form::model($item, ['method'=>'PATCH','action'=>['WomenbagController@update',$item->item_id],'files'=>true]) !!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="height" type="text" placeholder="Enter Height" value="{{$item->height}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="type" type="text" placeholder="Enter Type" value="{{$item->type}}"required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="pocket" class="col-2 col-form-label">Pocket :</label>
                    <input class="form-control" name ="pocket" type="text" placeholder="Enter Pocket" value="{{$item->pocket}}"required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="closure" class="col-2 col-form-label">Closure :</label>
                    <input class="form-control" name ="closure" type="text" placeholder="Enter Closure" value="{{$item->closure}}"required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="event" type="text" placeholder="Event" value="{{$item->event}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
