    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Laptops Insert
                ...
                {!!Form::open(['method'=>'POST', 'action'=>'LaptopController@store','files'=>true ])!!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="connectivity" type="text" placeholder="Enter Connectivity"   required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="battery" class="col-2 col-form-label">Battery :</label>
                    <input class="form-control" name ="battery" type="text" placeholder="Enter Battery"  required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
