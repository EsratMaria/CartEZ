                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                            <div class="row">
                                <div class="col-lg-20">
                                    <h2 class="row" style="padding-left: 60px;color: lightslategrey;">Edit Men's Panjabi Items
                                     </h2>

                                    {!!Form::model($item, ['method'=>'PATCH','action'=>['MenpanjabisController@update',$item->item_id],'files'=>true]) !!}
