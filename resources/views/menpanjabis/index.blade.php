                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row" style="padding-left: 70px;padding-right: 70px;">
                            <h2 style="font-size: 28px;color: lightslategrey;">Men's Panjabi collection
                                <a href="menpanjabis/create"><span class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-original-title="Add more Products"></span></a>
                               </h2>
                            <hr>
                            @if(count($items)!=0)
                                        ...
                                        <div class="thumbnail">
                                            ...
                                            <div class="text-center" style="margin-bottom: 50px;">
                                                ...
                                                <div style="padding-left: -20px; ">
                                                    {!!Form::model($item,['method'=>'GET','action'=>['MenpanjabisController@edit',$item->item_id]]) !!}
                                                    {{ csrf_field() }}
                                                ...
                                                <div>
                                                    {!!Form::model($item,['method'=>'DELETE','action'=>['MenpanjabisController@destroy',$item->item_id]]) !!}
                                                    {{ csrf_field() }}
