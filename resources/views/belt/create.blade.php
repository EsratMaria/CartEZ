    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Men's Belt Insert
                ...
                {!!Form::open(['method'=>'POST', 'action'=>'BeltController@store','files'=>true ])!!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="width" type="text" placeholder="Width" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="clasp" class="col-2 col-form-label">Clasp :</label>
                    <input class="form-control" name ="clasp" type="text" placeholder="Clasp" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
