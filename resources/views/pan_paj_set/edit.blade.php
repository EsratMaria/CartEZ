...
@section('content')
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;">Edit Men's Panjabi Pajama Set Items
                ...
                {!!Form::model($item, ['method'=>'PATCH','action'=>['Pan_paj_setController@update',$item->item_id],'files'=>true]) !!}
