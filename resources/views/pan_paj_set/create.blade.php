    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Men's Panjabi Pajama Set Insert
                ...
                {!!Form::open(['method'=>'POST', 'action'=>'Pan_paj_setController@store','files'=>true ])!!}
                {{ csrf_field() }}
