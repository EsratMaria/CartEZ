                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-lg-20">
                                ...
                                <h2 class="row" style="padding-left: 60px;color: lightslategrey;">Edit Desktop Items
                                </h2>
                                {!!Form::model($item, ['method'=>'PATCH','action'=>['ComputingdesktopsController@update',$item->item_id],'files'=>true]) !!}
                                {{ csrf_field() }}
                                ...
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="memory" class="col-2 col-form-label">Memory :</label>
                                    <input class="form-control" name ="memory" type="text" placeholder="Enter Memory Capacity" value="{{$item->memory}}"  required>
                                </div>

                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="hard_disk" class="col-2 col-form-label">Hard Disk :</label>
                                    <input class="form-control" name ="hard_disk" type="text" placeholder="Enter Hard Disk Details" value="{{$item->hard_disk}}"  required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="mother_board" class="col-2 col-form-label">Motherboard :</label>
                                    <input class="form-control" name ="mother_board" type="text" placeholder="Enter Motherboard Details" value="{{$item->mother_board}}"  required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="monitor" class="col-2 col-form-label">Monitor :</label>
                                    <input class="form-control" name ="monitor" type="text" placeholder="Enter Monitor Details" value="{{$item->monitor}}"  required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="graphics_card" class="col-2 col-form-label">Graphics Card :</label>
                                    <input class="form-control" name ="graphics_card" type="text" placeholder="Enter Graphics Card Details" value="{{$item->graphics_card}}"  required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="dimension" class="col-2 col-form-label">Dimension :</label>
                                    <input class="form-control" name ="dimension" type="text" placeholder="Enter Dimension" value="{{$item->dimension}}" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                ...
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="cpu" class="col-2 col-form-label">CPU :</label>
                                    <input class="form-control" name ="cpu" type="text" placeholder="Enter CPU" value="{{$item->cpu}}" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                ...
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="audio" class="col-2 col-form-label">Audio :</label>
                                    <input class="form-control" name ="audio" type="text" placeholder="Enter Audio details" value="{{$item->audio}}" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="lan" class="col-2 col-form-label">LAN :</label>
                                    <input class="form-control" name ="lan" type="text" placeholder="Enter LAN details " value="{{$item->lan}}" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="mouse" class="col-2 col-form-label">Mouse :</label>
                                    <input class="form-control" name ="mouse" type="text" placeholder="Enter Mouse details" value="{{$item->mouse}}" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="keyboard" class="col-2 col-form-label">Keyboard :</label>
                                    <input class="form-control" name ="keyboard" type="text" placeholder="Enter Keyboard details" value="{{$item->keyboard}}" required>
                                </div>
