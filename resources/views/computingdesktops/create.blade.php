                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-lg-20">
                                ...
                                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Desktops Insert
                                </h2>
                                {!!Form::open(['method'=>'POST', 'action'=>'ComputingdesktopsController@store','files'=>true ])!!}
                                {{ csrf_field() }}
                                ...
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    ...
                                    <input class="form-control" name ="memory" type="text" placeholder="Enter Memory Capacity" required>
                                </div>

                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="hard_disk" class="col-2 col-form-label">Hard Disk :</label>
                                    <input class="form-control" name ="hard_disk" type="text" placeholder="Enter Hard Disk Details" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="mother_board" class="col-2 col-form-label">Motherboard :</label>
                                    <input class="form-control" name ="mother_board" type="text" placeholder="Enter Motherboard Details" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="monitor" class="col-2 col-form-label">Monitor :</label>
                                    <input class="form-control" name ="monitor" type="text" placeholder="Enter Monitor Details" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="graphics_card" class="col-2 col-form-label">Graphics Card :</label>
                                    <input class="form-control" name ="graphics_card" type="text" placeholder="Enter Graphics Card Details" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="dimension" class="col-2 col-form-label">Dimension :</label>
                                    <input class="form-control" name ="dimension" type="text" placeholder="Enter Dimension" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                ...
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    ...
                                    <input class="form-control" name ="cpu" type="text" placeholder="Enter CPU " required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                ...
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    ...
                                    <input class="form-control" name ="audio" type="text" placeholder="Enter Audio details" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="lan" class="col-2 col-form-label">LAN :</label>
                                    <input class="form-control" name ="lan" type="text" placeholder="Enter LAN details " required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="mouse" class="col-2 col-form-label">Mouse :</label>
                                    <input class="form-control" name ="mouse" type="text" placeholder="Enter Mouse details" required>
                                </div>
                                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                                    <label for="keyboard" class="col-2 col-form-label">Keyboard :</label>
                                    <input class="form-control" name ="keyboard" type="text" placeholder="Enter Keyboard details" required>
                                </div>
