                        ...
                        <!-- PAGE CONTENT BEGINS -->
                            <div class="row">
                                <div class="col-lg-20">
                                    ...
                                    {!!Form::model($item, ['method'=>'PATCH','action'=>['WomenshareesController@update',$item->item_id],'files'=>true]) !!}
                                    {{ csrf_field() }}

                                    <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 800px;">
                                    ...
                                    <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 800px;">
                                        <label for="trims" class="col-2 col-form-label">Trims :</label>
                                        <input class="form-control" name ="trims" type="text" placeholder="Enter Trims" value="{{$item->trims}}" required>
                                    </div>

                                    <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 800px;">
                                        <label for="aanchal" class="col-2 col-form-label">Aanchal :</label>
                                        <input class="form-control" name ="aanchal" type="text" placeholder="Enter Aanchal" value="{{$item->aanchal}}" required>
                                    </div>

                                    <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 800px;">
                                        <label for="body" class="col-2 col-form-label">Body :</label>
                                        <input class="form-control" name ="body" type="text" placeholder="Enter Body" value="{{$item->body}}" required>
                                    </div>
                                    <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 800px;">
                                    ...
                                    <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 800px;">
                                        <label for="blouse_piece" class="col-2 col-form-label">Blouse Piece :</label>
                                        <input class="form-control" name ="blouse_piece" type="text" placeholder="Enter Blouse Piece" value="{{$item->blouse_piece}}" required>
                                    </div>
