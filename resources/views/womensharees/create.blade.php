                        ...
                        <!-- PAGE CONTENT BEGINS -->
                            <div class="row">
                                <div class="col-lg-20">
                                    ...
                                    <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Insert Women's Sharee
                                    </h2>
                                    {!!Form::open(['method'=>'POST', 'action'=>'WomenshareesController@store','files'=>true ])!!}
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 800px;">
                                        ...
                                        <input class="form-control" name ="trims" type="text" placeholder="Enter Trims" required>
                                    </div>

                                    <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 800px;">
                                        <label for="aanchal" class="col-2 col-form-label">Aanchal :</label>
                                        <input class="form-control" name ="aanchal" type="text" placeholder="Enter Aanchal" required>
                                    </div>
                                    ...
                                    <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 800px;">
                                        ...
                                        <input class="form-control" name ="blouse_piece" type="text" placeholder="Enter Blouse Piece" required>
                                    </div>
