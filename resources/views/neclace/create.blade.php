    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Women's Necklace Insert
                ...
                {!!Form::open(['method'=>'POST', 'action'=>'NeclaceController@store','files'=>true ])!!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="pattern" type="text" placeholder="Enter Pattern" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="metal_type" type="text" placeholder="Enter Metal Type" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="chain_type" class="col-2 col-form-label">Chain Type :</label>
                    <input class="form-control" name ="chain_type" type="text" placeholder="Enter Chain Type" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="necklace_type" class="col-2 col-form-label">Nacklace Type :</label>
                    <input class="form-control" name ="necklace_type" type="text" placeholder="Enter Necklace Type" required>
                </div>
