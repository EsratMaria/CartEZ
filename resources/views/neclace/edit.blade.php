    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Edit Women's Necklace
                ...
                {!!Form::model($item, ['method'=>'PATCH','action'=>['NeclaceController@update',$item->item_id],'files'=>true]) !!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    ...
                    <input class="form-control" name ="style" type="text" placeholder="Enter Style" value="{{$item->style}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="pattern" class="col-2 col-form-label">Pattern :</label>
                    <input class="form-control" name ="pattern" type="text" placeholder="Enter Pattern" value="{{$item->pattern}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="metal_type" class="col-2 col-form-label">Metal Type :</label>
                    <input class="form-control" name ="metal_type" type="text" placeholder="Enter Metal Type" value="{{$item->metal_type}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="chain_type" class="col-2 col-form-label">Chain Type :</label>
                    <input class="form-control" name ="chain_type" type="text" placeholder="Enter Chain Type" value="{{$item->chain_type}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="necklace_type" class="col-2 col-form-label">Nacklace Type :</label>
                    <input class="form-control" name ="necklace_type" type="text" placeholder="Enter Necklace Type" value="{{$item->necklace_type}}" required>
                </div>
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
