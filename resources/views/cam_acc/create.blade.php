    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;">Camera Accessory product Insert
                ...
                {!!Form::open(['method'=>'POST', 'action'=>'Cam_accController@store','files'=>true ])!!}
                {{ csrf_field() }}
