    ...
    <div class="well">
        <div class="row">
            <div class="col-lg-20">
                ...
                <h2 class="row" style="padding-left: 60px;color: lightslategrey;"> Edit Women's Purse
                ...
                {!!Form::model($item, ['method'=>'PATCH','action'=>['PurseController@update',$item->item_id],'files'=>true]) !!}
                {{ csrf_field() }}
                ...
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
                    <label for="interior_type" class="col-2 col-form-label">Interior Type :</label>
                    <input class="form-control" name ="interior_type" type="text" placeholder="Enter Interior Type" value="{{$item->interior_type}}"required>
                </div>1`
                <div class="form-group row" style="padding-left: 60px; padding-top: 30px; width: 1300px;">
