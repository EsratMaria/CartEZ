...
@section('content')
    ...
    <div class="row" style="padding-left: 70px;padding-right: 70px;">
        <h2 style="font-size: 28px;color: lightslategrey;">Women's Dupatta collection
            <a href="dupatta/create"><span class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-original-title="Add more Products"></span></a>
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="text-center" style="margin-bottom: 50px;">
                            ...
                            <div style="padding-left: 110px; ">
                                {!!Form::model($item,['method'=>'GET','action'=>['DupattaController@edit',$item->item_id]]) !!}
                                {{ csrf_field() }}
                            ...
                            <div>
                                {!!Form::model($item,['method'=>'DELETE','action'=>['DupattaController@destroy',$item->item_id]]) !!}
                                {{ csrf_field() }}
