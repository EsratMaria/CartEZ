        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#">Transactions From Your Shop</a>
                    </li>
                </ul><!-- /.breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="table-header">
                            Results for "Latest Shop Transaction"
                        </div>
        ...
        <div class="footer-inner">
            <div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">CartEZ</span>
							&copy; 2017
						</span>
...
<!-- page specific plugin scripts -->
    ...
    <script type="text/javascript" src="{{URL::asset('assets/js/jquery.dataTables.bootstrap.min.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('assets/js/dataTables.buttons.min.js')}}"></script>
...
<script src="assets/js/buttons.colVis.min.js"></script>
    ...
    <script type="text/javascript" src="{{URL::asset('assets/js/dataTables.select.min.js')}}"></script>
