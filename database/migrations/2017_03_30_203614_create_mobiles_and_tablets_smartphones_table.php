...
class CreateMobilesAndTabletsSmartphonesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mobiles_and_tablets_smartphones', function (Blueprint $table) {
    ...
    {
        Schema::drop('mobiles_and_tablets_smartphones');
    }
}
