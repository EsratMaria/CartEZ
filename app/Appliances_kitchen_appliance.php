...
class Appliances_kitchen_appliance extends Model
{
    protected $table = 'appliances-kitchen_appliances';
    protected $fillable = [
        'item_id', 'subcategory_id', 'title','description','price','quantity','color','date',
        'sku','weight','brand','type','manufacture','warranty','shop_id','img_loc'
    ];
