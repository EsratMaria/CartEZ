...
class Men_bag extends Model
{
    protected $table = 'men-bags';
    protected $fillable = [
        'item_id', 'subcategory_id', 'title','description','price','quantity','color','date','material',
        'length','width','strap_length','lining','handle','strap','strap_material','measurementunit','occasion','shop_id','img_loc'
    ];
