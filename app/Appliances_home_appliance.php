...
class Appliances_home_appliance extends Model
{
    protected $table = 'appliances-home_appliances';
    protected $fillable = [
        'item_id', 'subcategory_id', 'title','description','price','quantity','color','date',
        'sku','weight','brand','size','type','manufacture','warranty','shop_id','img_loc'
    ];
