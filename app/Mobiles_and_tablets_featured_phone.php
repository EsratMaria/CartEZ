...
class Mobiles_and_tablets_featured_phone extends Model
{
    protected $table = 'mobiles_and_tablets-featured_phones';
    protected $fillable = [
        ...
        'sim_card','battery_mah','connectivity','model','shop_id','img_loc'
    ];
