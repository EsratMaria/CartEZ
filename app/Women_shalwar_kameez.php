...
class Women_shalwar_kameez extends Model
{
    protected $table = 'women-shalwar_kameezs';
    protected $fillable = [
        'item_id', 'subcategory_id', 'title','description','price','quantity','fabric','color','date','size',
        'value_addition','dupatta_color','bottom_color','dupatta_value_addition','bottom_value_addition',
        'dupatta_fabric','bottom_fabric','sleeve','length','waist','lining','occasion','event','care','shop_id','img_loc'
    ];
