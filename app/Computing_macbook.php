...
class Computing_macbook extends Model
{
    protected $table = 'computing-macbooks';
    protected $fillable = [
        'item_id', 'subcategory_id', 'title','description','price','quantity','color','date',
        'brand','processor','sku','weight','cpu_speed','ram','display','battery', 'warranty','shop_id','img_loc'
    ];
