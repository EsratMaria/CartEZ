...
class Women_bag extends Model
{
    protected $table = 'women-bags';
    protected $fillable = [
        'item_id', 'subcategory_id', 'title','description','price','quantity','color','date','material',
        'value_addition','height','length','width','strap','strap_length','type','pocket','closure',
        'lining','handle', 'strap_material','measurementunit','occasion','event','care','shop_id','img_loc'
    ];
