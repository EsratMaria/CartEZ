...
class MenshoeController extends Controller
{
    ...
    {
        $items=Men_shoe::all();
        return view('menshoe.index',compact('items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\men-shoes',$imgname);
            $img_name="\\men-shoes\\".$imgname;
    ...
    {
        $item= Men_shoe::findOrFail($id);
        return view('menshoe.edit', compact('item'));
    }
