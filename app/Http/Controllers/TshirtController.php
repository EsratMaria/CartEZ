...
class TshirtController extends Controller
{
    ...
    {
        $items=Men_t_shirt::all();
        return view('tshirt.index',compact('items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $name= 'men_tshirt'."_". $row_number;
        $men_panjabi =new Men_t_shirt;
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\men-t_shirts',$imgname);
            $img_name="\\men-t_shirts\\".$imgname;
...
//
    ...
    {
        $item= Men_t_shirt::findOrFail($id);
        return view('tshirt.edit', compact('item'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $men_panjabi= Men_t_shirt::findOrFail($id);
        $men_panjabi['title'] = $request->get('title');
        $men_panjabi['description'] = $request->get('description');
        $men_panjabi['price'] = $request->get('price');
        $men_panjabi['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="men-t_shirts";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
