...
use App\Item_tag;
use App\Product;
use App\Tv_and_electronics_home_theater;
...
class TheaterController extends Controller
{
    ...
    {
        $items=Tv_and_electronics_home_theater::all();
        return view('theater.index',compact('items'));
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $obj="tv_and_electronics-home_theaters";
        $subcat=33;
        $row_number=rand(1,9999999);
        $name= 'home_theater'."_". $row_number;
        $smart =new Tv_and_electronics_home_theater;
        $smart['item_id'] = $name;
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\tv_and_electronics-home_theaters',$imgname);
            $img_name="\\tv_and_electronics-home_theaters\\".$imgname;
    ...
    {
        $item= Tv_and_electronics_home_theater::findOrFail($id);
        return view('theater.edit', compact('item'));
    }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        $smart =Tv_and_electronics_home_theater::findOrFail($id);
        $smart['title'] = $request->get('title');
        $smart['description'] = $request->get('description');
        $smart['price'] = $request->get('price');
        $smart['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="tv_and_electronics-home_theaters";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
