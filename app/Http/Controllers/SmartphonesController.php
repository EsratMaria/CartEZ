...
class SmartphonesController extends Controller
{
    ...
    {
        $items=Mobiles_and_tablets_smartphone::all();
        return view('smartphones.index',compact('items'));
    }
...
//            'date'=>'required',
        ...
        $obj="mobiles_and_tablets-smartphones";
        $subcat=21;
        $row_number=rand(1,9999999);
        $name= 'mob_smart'."_". $row_number;
        $smart =new Mobiles_and_tablets_smartphone;
        $smart['item_id'] = $name;
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\mobiles_and_tablets-smartphones',$imgname);
            $img_name="\\mobiles_and_tablets-smartphones\\".$imgname;
    ...
    {
        $item= Mobiles_and_tablets_smartphone::findOrFail($id);
        return view('smartphones.edit', compact('item'));
    }
...
//            'date'=>'required',
        ...
        $smart =Mobiles_and_tablets_smartphone::findOrFail($id);
        $smart['title'] = $request->get('title');
        $smart['description'] = $request->get('description');
        $smart['price'] = $request->get('price');
        $smart['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="mobiles_and_tablets-smartphones";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
