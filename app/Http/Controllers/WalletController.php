...
class WalletController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $name= 'men_wallet'."_". $row_number;
        $smart =new Men_wallet;
        $smart['item_id'] = $name;
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\men-wallets',$imgname);
            $img_name="\\men-wallets\\".$imgname;
    ...
    {
        $item= Men_wallet::findOrFail($id);
        return view('wallet.edit', compact('item'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $smart =Men_wallet::findOrFail($id);
        $smart['title'] = $request->get('title');
        $smart['description'] = $request->get('description');
        $smart['price'] = $request->get('price');
        $smart['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="men-wallets";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
