...
class BeltController extends Controller
{
    ...
    {
        $items=Men_belts::all();
        return view('belt.index',compact('items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\men-belts',$imgname);
            $img_name="\\men-belts\\".$imgname;
    ...
    {
        $item= Men_belts::findOrFail($id);
        return view('belt.edit', compact('item'));
    }
