...
class SingleController extends Controller
{
    ...
    {
        $items=Women_single_piece::all();
        return view('single.index',compact('items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $obj="women-single_pieces";
        $subcat=10;
        $row_number=rand(1,9999999);
        $name= 'single_piece'."_". $row_number;
        $men_panjabi =new Women_single_piece;
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\women-single_pieces',$imgname);
            $img_name="\\women-single_pieces\\".$imgname;
...
//
    ...
    {
        $item= Women_single_piece::findOrFail($id);
        return view('single.edit', compact('item'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $men_panjabi= Women_single_piece::findOrFail($id);
        $men_panjabi['title'] = $request->get('title');
        $men_panjabi['description'] = $request->get('description');
        $men_panjabi['price'] = $request->get('price');
        $men_panjabi['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="women-single_pieces";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
