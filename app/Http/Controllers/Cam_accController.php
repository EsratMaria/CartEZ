...
class Cam_accController extends Controller
{
    /**
    ...
    {
        $items=Cameras_and_accessories_accessory::all();
        return view('cam_acc.index',compact('items'));
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $obj="cameras_and_accessories-accessories";
        $subcat=35;
        $row_number=rand(1,9999999);
        $name= 'cam_acc'."_". $row_number;
        $smart =new Cameras_and_accessories_accessory();
        $smart['item_id'] = $name;
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\cameras_and_accessories-accessories',$imgname);
            $img_name="\\cameras_and_accessories-accessories\\".$imgname;
    ...
    {
        $item= Cameras_and_accessories_accessory::findOrFail($id);
        return view('cam_acc.edit', compact('item'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $smart =Cameras_and_accessories_accessory::findOrFail($id);
        $smart['title'] = $request->get('title');
        $smart['description'] = $request->get('description');
        $smart['price'] = $request->get('price');
        $smart['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="cameras_and_accessories-accessories";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
