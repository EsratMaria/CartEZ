...
class SmarttvController extends Controller
{
    ...
    {
        $items=Tv_and_electronics_smart_tv::all();
    ...
    public function store(Request $request)
    {
        ...
        $obj="tv_and_electronics-smart_tvs";
        $subcat=30;
        $row_number=rand(1,9999999);
        $name= 'tv_smart'."_". $row_number;
        $smart =new Tv_and_electronics_smart_tv;
        $smart['item_id'] = $name;
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\tv_and_electronics-smart_tvs',$imgname);
            $img_name="\\tv_and_electronics-smart_tvs\\".$imgname;
    ...
    {
        $item= Tv_and_electronics_smart_tv::findOrFail($id);
        return view('smarttv.edit', compact('item'));
    }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        $smart =Tv_and_electronics_smart_tv::findOrFail($id);
        $smart['title'] = $request->get('title');
        $smart['description'] = $request->get('description');
        $smart['price'] = $request->get('price');
        $smart['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="tv_and_electronics-smart_tvs";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
