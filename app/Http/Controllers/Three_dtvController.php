...
class Three_dtvController extends Controller
{
    /**
    ...
    {
        $items=Tv_and_electronics_3d_tv::all();
        return view('three_dtv.index',compact('items'));
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $obj="tv_and_electronics-3d_tvs";
        $subcat=31;
        $row_number=rand(1,9999999);
        $name= 'tv_3d'."_". $row_number;
        $smart =new Tv_and_electronics_3d_tv;
        $smart['item_id'] = $name;
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\tv_and_electronics-3d_tvs',$imgname);
            $img_name="\\tv_and_electronics-3d_tvs\\".$imgname;
    ...
    {
        $item= Tv_and_electronics_3d_tv::findOrFail($id);
        return view('three_dtv.edit', compact('item'));
    }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        $smart =Tv_and_electronics_3d_tv::findOrFail($id);
        $smart['title'] = $request->get('title');
        $smart['description'] = $request->get('description');
        $smart['price'] = $request->get('price');
        $smart['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="tv_and_electronics-3d_tvs";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
