...
use App\Item_image;
use App\Item_tag;
use App\Men_cufflink;
use App\Product;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Session;

class CufflinkController extends Controller
{
    /**
    ...
    {
        $items=Men_cufflink::all();
        return view('cufflink.index',compact('items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $name= 'men_cuff'."_". $row_number;
        $smart =new Men_cufflink;
        $smart['item_id'] = $name;
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\men-cufflinks',$imgname);
            $img_name="\\men-cufflinks\\".$imgname;
    ...
    {
        $item= Men_cufflink::findOrFail($id);
        return view('cufflink.edit', compact('item'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $smart =Men_cufflink::findOrFail($id);
        $smart['title'] = $request->get('title');
        $smart['description'] = $request->get('description');
        $smart['price'] = $request->get('price');
        $smart['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="men-cufflinks";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
