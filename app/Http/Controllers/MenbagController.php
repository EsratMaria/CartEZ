...
class MenbagController extends Controller
{
    /**
    ...
    {
        $items=Men_bag::all();
        return view('menbag.index',compact('items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\men-bags',$imgname);
            $img_name="\\men-bags\\".$imgname;
    ...
    {
        $item= Men_bag::findOrFail($id);
        return view('menbag.edit', compact('item'));
    }
