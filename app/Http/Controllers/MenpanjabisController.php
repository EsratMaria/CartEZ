...
class MenpanjabisController extends Controller
{
    /**
    ...
    {
       return view('menpanjabis.create');
...
//            'date'=>'required',
        ...
        $name= 'men_panj'."_". $row_number;
        $men_panjabi =new Men_panjabi;
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\men-panjabis',$imgname);
            $img_name="\\men-panjabis\\".$imgname;
    ...
    {
        $item= Men_panjabi::findOrFail($id);
        return view('menpanjabis.edit', compact('item'));
    }
...
//            'date'=>'required',
        ...
        $men_panjabi= Men_panjabi::findOrFail($id);
        $men_panjabi['title'] = $request->get('title');
        $men_panjabi['description'] = $request->get('description');
        $men_panjabi['price'] = $request->get('price');
        $men_panjabi['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="men-panjabis";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
