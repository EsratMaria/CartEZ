...
class WomenshoeController extends Controller
{
    ...
    {
        $items=Women_shoe::all();
        return view('womenshoe.index',compact('items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $name= 'women_shoe'."_". $row_number;
        $smart =new Women_shoe;
        $smart['item_id'] = $name;
        ...
        $smart['size'] = $request->get('size');
        $smart['upper'] = $request->get('upper');
        $smart['upper_value_addition'] = $request->get('upper_value_addition');
        $smart['lining'] = $request->get('lining');
        $smart['sole'] = $request->get('sole');
        $smart['toe'] = $request->get('toe');
        $smart['straps'] = $request->get('straps');
        $smart['heel'] = $request->get('heel');
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\women-shoes',$imgname);
            $img_name="\\women-shoes\\".$imgname;
    ...
    {
        $item= Women_shoe::findOrFail($id);
        return view('womenshoe.edit', compact('item'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $smart =Women_shoe::findOrFail($id);
        $smart['title'] = $request->get('title');
        $smart['description'] = $request->get('description');
        $smart['price'] = $request->get('price');
        $smart['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="women-shoes";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
