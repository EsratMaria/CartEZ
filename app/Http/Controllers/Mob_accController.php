...
class Mob_accController extends Controller
{
    /**
    ...
    {
        $items=Mobiles_and_tablets_accessory::all();
        return view('mob_acc.index',compact('items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $obj="mobiles_and_tablets-accessories";
        $subcat=24;
        $row_number=rand(1,9999999);
        $name= 'mob_acc'."_". $row_number;
        $smart =new Mobiles_and_tablets_accessory();
        $smart['item_id'] = $name;
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\mobiles_and_tablets-accessories',$imgname);
            $img_name="\\mobiles_and_tablets-accessories\\".$imgname;
    ...
    {
        $item= Mobiles_and_tablets_accessory::findOrFail($id);
        return view('mob_acc.edit', compact('item'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $smart =Mobiles_and_tablets_accessory::findOrFail($id);
        $smart['title'] = $request->get('title');
        $smart['description'] = $request->get('description');
        $smart['price'] = $request->get('price');
        $smart['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="mobiles_and_tablets-accessories";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
