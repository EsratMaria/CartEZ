...
class Pan_paj_setController extends Controller
{
    /**
    ...
    {
        $items=Men_panjabi_pajama_set::all();
        return view('pan_paj_set.index',compact('items'));
    }
    ...
    {
        return view('pan_paj_set.create');
    ...
    public function store(Request $request)
    {
        ...
        $obj="men-panjabi_pajama_sets";
        $subcat=3;
        $row_number=rand(1,9999999);
        $name= 'pan_paj_set'."_". $row_number;
        $men_panjabi =new Men_panjabi_pajama_set;
        ...
        $men_panjabi['length'] = $request->get('length');
        ...
        if($file = $request->file('image1')){
            ...
            $file->move('images\men-panjabi_pajama_sets',$imgname);
            $img_name="\\men-panjabi_pajama_sets\\".$imgname;
...
//
    ...
    {
        $item= Men_panjabi_pajama_set::findOrFail($id);
        return view('pan_paj_set.edit', compact('item'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $men_panjabi= Men_panjabi_pajama_set::findOrFail($id);
        $men_panjabi['title'] = $request->get('title');
        $men_panjabi['description'] = $request->get('description');
        $men_panjabi['price'] = $request->get('price');
        $men_panjabi['quantity'] = $request->get('quantity');
        ...
        $item_tag['prod_id']=$id;
        $item_tag['table_name']="men-panjabi_pajama_sets";
        $item_tag['tag_text']=$request->get('tag_text');
        $item_tag->save();
