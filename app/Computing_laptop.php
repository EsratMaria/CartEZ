...
class Computing_laptop extends Model
{
    protected $table = 'computing-laptops';
    protected $fillable = [
        'item_id', 'subcategory_id', 'title','description','price','quantity','color','date',
        'brand','processor','sku','weight','manufacture','cpu_speed','ram', 'connectivity','display','battery',
        'warranty','shop_id','img_loc'
    ];
