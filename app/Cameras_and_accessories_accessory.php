...
class Cameras_and_accessories_accessory extends Model
{
    protected $table = 'cameras_and_accessories-accessories';
    protected $fillable = [
        'item_id', 'subcategory_id', 'title','description','price','quantity','color','date',
        'sku','weight','brand','manufacture','warranty','shop_id','img_loc'
    ];
